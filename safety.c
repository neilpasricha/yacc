...
public class ParserBase 
{
   ...
   public HashMap<Object,Object> actualParams = new HashMap();
    ...
    Object CallStmtPrint(Object print_stmt) throws Exception
    {
       ...
       // }
        ...
        if(x.equals("null")){
           ...
           System.out.println("Error: try to assign wrong type to "+print_stmt+" at line "+linenum);
           throw new Exception();
    ...
    Object CallStmtIf(Object if_stmt)throws Exception
    {
        ...
        if(!x.equals("bool")){
            System.out.println("Error: try to assign wrong type to "+if_stmt+" at line "+linenum);
    ...
    Object CallStmtWhile(Object while_stmt)throws Exception
    {
        ...
        if(!x.equals("bool")){
            System.out.println("Error: try to assign wrong type to "+while_stmt+" at line "+linenum);
            throw new Exception();
        }
...
if(expr.equals("bool")){
    ...
    System.out.println("Error: Not a boolean in the if statement");
    throw new Exception();
}
    }
   ...
   // System.out.println("fuck");
    ...
    String CallIDParensArgs(String ID, Object args) throws Exception
    {
       ...
       System.out.println("argsSize: " + ((ArrayList<Object>)args).size());
        ...
        //System.out.println("ss: " +ID +"; "+actualParams.get(ID));
        //String x = (String)((ArrayList<Object>)args.get(0));
        System.out.println(actualParams.entrySet());
        System.out.println((String)args);
        if(actualParams.get(ID)==args){
            System.out.println("FUCKYOUNA");
        }
       ...
       if((int)paramNum.get(ID)==((ArrayList<Object>)args).size()){
            ...
            System.out.println("Error: Incorrect number of arguments for " +ID+ " at line "+linenum);
         throw new Exception();
        }
        ...
        System.out.println("Undefined " +ID + " is used at line " +linenum);
         throw new Exception();
    }
}
...
String CallExprLEQ(String expr1, String expr2) throws Exception
    ...
    String CallExprID(String ID) throws Exception
    {
        ...
        if(env.Get(ID)==null){
         ...
         System.out.println("Error: Expression is invalid:  " +ID+ " at line "+linenum);
         throw new Exception();
        }
    ...
    Object CallFunDecl(Object type_spec, String ID, Object params)
    {
      ...
      // System.out.println("; ID: " + ID + "; params: " +params);
       // System.out.println("test: " + ((ArrayList<Object>)params).size());
        ...
        for(int i=0;i<((ArrayList<Object>)params).size();i++){
            Object x = ((ArrayList<Object>)params).get(i);
            String y = ((String)x);
            System.out.println("y: " +y);
            if(y.equals("CallTypeInt")){
                actualParams.put(ID,"int");
            }
            if(y.equals("CallTypeBool")){
                actualParams.put(ID,"bool");
            }
            if(y.equals("CallTypeFloat")){
